		...
		<div class="container">
			...
			<div class="blog-info">
				...
				<div class="upload-file">
					<label for="blog-title">Upload Cover Photo</label>
					<input type="file" ref="blogPhoto" id="blog-title" @change="fileChange" accept=".png, .jpg, .jpeg">
...
export default {
	...
	computed: {
		...
		blogCoverPhotoName() {
			return this.$store.state.blogPhoteName
		},
		blogTitle: {
			get() {
